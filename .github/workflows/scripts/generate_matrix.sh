...
if [ "$MATRIX_LINUX_5_9_ENABLED" == "true" ]; then
  matrix_append_definition "Linux" "ubuntu-latest" "5.9" "focal" "" "$MATRIX_LINUX_PRE_BUILD_COMMAND" "$MATRIX_LINUX_BUILD_COMMAND" "${MATRIX_LINUX_5_9_BUILD_COMMAND_OPTIONS:-$MATRIX_LINUX_BUILD_COMMAND_OPTIONS}"
fi

if [ "$MATRIX_LINUX_5_10_ENABLED" == "true" ]; then
  matrix_append_definition "Linux" "ubuntu-latest" "5.10" "noble" "" "$MATRIX_LINUX_PRE_BUILD_COMMAND" "$MATRIX_LINUX_BUILD_COMMAND" "${MATRIX_LINUX_5_10_BUILD_COMMAND_OPTIONS:-$MATRIX_LINUX_BUILD_COMMAND_OPTIONS}"
fi

if [ "$MATRIX_LINUX_6_0_ENABLED" == "true" ]; then
  matrix_append_definition "Linux" "ubuntu-latest" "6.0" "noble" "" "$MATRIX_LINUX_PRE_BUILD_COMMAND" "$MATRIX_LINUX_BUILD_COMMAND" "${MATRIX_LINUX_6_0_BUILD_COMMAND_OPTIONS:-$MATRIX_LINUX_BUILD_COMMAND_OPTIONS}"
fi

if [ "$MATRIX_LINUX_6_1_ENABLED" == "true" ]; then
  matrix_append_definition "Linux" "ubuntu-latest" "6.1" "noble" "" "$MATRIX_LINUX_PRE_BUILD_COMMAND" "$MATRIX_LINUX_BUILD_COMMAND" "${MATRIX_LINUX_6_1_BUILD_COMMAND_OPTIONS:-$MATRIX_LINUX_BUILD_COMMAND_OPTIONS}"
fi

if [ "$MATRIX_LINUX_6_2_ENABLED" == "true" ]; then
  matrix_append_definition "Linux" "ubuntu-latest" "6.2" "noble" "" "$MATRIX_LINUX_PRE_BUILD_COMMAND" "$MATRIX_LINUX_BUILD_COMMAND" "${MATRIX_LINUX_6_2_BUILD_COMMAND_OPTIONS:-$MATRIX_LINUX_BUILD_COMMAND_OPTIONS}"
fi

if [ "$MATRIX_LINUX_6_3_ENABLED" == "true" ]; then
  matrix_append_definition "Linux" "ubuntu-latest" "6.3" "noble" "" "$MATRIX_LINUX_PRE_BUILD_COMMAND" "$MATRIX_LINUX_BUILD_COMMAND" "${MATRIX_LINUX_6_3_BUILD_COMMAND_OPTIONS:-$MATRIX_LINUX_BUILD_COMMAND_OPTIONS}"
fi

if [ "$MATRIX_LINUX_NIGHTLY_RELEASE_ENABLED" == "true" ]; then
  matrix_append_definition "Linux" "ubuntu-latest" "nightly-6.3" "noble" "" "$MATRIX_LINUX_PRE_BUILD_COMMAND" "$MATRIX_LINUX_BUILD_COMMAND" "${MATRIX_LINUX_NIGHTLY_RELEASE_BUILD_COMMAND_OPTIONS:-$MATRIX_LINUX_BUILD_COMMAND_OPTIONS}"
fi

if [ "$MATRIX_LINUX_NIGHTLY_MAIN_ENABLED" == "true" ]; then
  matrix_append_definition "Linux" "ubuntu-latest" "nightly-main" "noble" "" "$MATRIX_LINUX_PRE_BUILD_COMMAND" "$MATRIX_LINUX_BUILD_COMMAND" "${MATRIX_LINUX_NIGHTLY_MAIN_BUILD_COMMAND_OPTIONS:-$MATRIX_LINUX_BUILD_COMMAND_OPTIONS}"
fi
